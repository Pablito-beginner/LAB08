...
public class MainActivity extends AppCompatActivity {
    ...
    private void aktualizuj() {
        ...
        dataZmiany = bazaDanych.pozycjaMagazynowaDAO().findDateByName(wybraneWarzywoNazwa);
        binding.tekstDataCzas.setText(dataZmiany);
        binding.historia.setText("");

        HistoriaPozycji[] historiaPozycji = bazaDanych.pozycjaMagazynowaDAO().showHistoryByName(wybraneWarzywoNazwa);
    ...
    private void zmienStan(OperacjaMagazynowa operacja) {
        ...
        bazaDanych.pozycjaMagazynowaDAO().updateDateByName(dataZmiany, wybraneWarzywoNazwa);
